        ...
        <div className="mb-1">
          ...
          <div className="space-y-1">
              ...
              <Link href="/return-status/personal">
                <div
                  className={`group flex items-center gap-3 px-2.5 py-2 rounded-lg cursor-pointer transition-colors ${
                    location === "/return-status/personal" ? "bg-accent" : "hover:bg-accent/50"
                  }`}
                >
            ...
            {businessReturns.map((ret) => (
              <Link key={ret.id} href={"/return-status/" + ret.id}>
                <div
                  className={`group flex items-center gap-3 px-2.5 py-2 rounded-lg cursor-pointer transition-colors ${
                    location === "/return-status/" + ret.id ? "bg-accent" : "hover:bg-accent/50"
                  }`}
                >
            ...
            {clientProducts.map((cp) => {
              ...
              return (
                <Link key={cp.id} href={"/service-status/" + cp.id}>
                  <div
                    className={`group flex items-center gap-3 px-2.5 py-2 rounded-lg cursor-pointer transition-colors ${
                      location === "/service-status/" + cp.id ? "bg-accent" : "hover:bg-accent/50"
                    }`}
                  >
